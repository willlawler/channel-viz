(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'tySu8vkGNjECtJz77M5JQJQtLhozqTQAoXur2637nHGIUxMq', // Unique master Xively API key to be used as a default
		defaultFeeds	= [570476090], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Will's Home, // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
